...
class PalindromeDemo{
    public static void main(String[] args) {
        ...
        int pal = 554455;
        if (pal <0)
            System.out.println("The number is negative. It can't be a palindrome.");
                else {
        if (sol.isPalindrome(pal)) System.out.println(pal + " is the palindrome number");
            else System.out.println(pal + " is not the palindrome number");
        }
    }
}